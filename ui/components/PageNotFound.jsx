...
const PageNotFound = () => (
    <blockquote style={{padding: '15px'}}>
        ...
        <ul>
            ...
            <li><b>E-mail us</b> - If you followed a link from somewhere, please let us know at <a href='mailto:support@softwaregroup.com'>support@softwaregroup.com</a>. Tell us where you came from and what you were looking for, and we'll do our best to fix it.</li>
        </ul>
    </blockquote>
);
