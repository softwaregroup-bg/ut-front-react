...
import frontDocumentsObject from './containers/DocumentsObject/reducer';

export default {login, /* loginData, */ gate, /* form, */ ...master, frontDocuments, frontDocumentsObject};
